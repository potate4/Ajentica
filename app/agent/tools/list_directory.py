...
from app.agent.tools._common import resolve_safe, trace_tool
from app.trace.base import TraceCollector

SKIP = {".git", "__pycache__", ".pytest_cache", "node_modules", ".venv", "venv"}


def build_list_directory_tool(repo_root: Path, trace: TraceCollector | None = None):
    @tool("list_directory")
    def list_directory(path: str = ".") -> str:
        ...
        return trace_tool("list_directory", {"path": path}, _run, trace=trace)
